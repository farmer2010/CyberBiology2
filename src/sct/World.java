...
public class World extends JPanel{
	...
	public void paintComponent(Graphics canvas) {
		...
		canvas.fillRect(0, H - sea_level * 10, W, sea_level * 10);
		canvas.setColor(new Color(128, 70, 0));
		canvas.fillRect(0, H - mud_level * 10, W, mud_level * 10);
		//for (int x = 0; x < 162; x++) {
		//	for (int y = 0; y < 108; y++) {
		//		if (Map[x][y] == 1) {
		...
		canvas.drawString("Adaptation:", W - 300, 650);
		canvas.drawString(String.valueOf(sea_level), W - 40, 680);
		canvas.drawString(String.valueOf(mud_level), W - 40, 720);
		canvas.drawString(String.valueOf(pht_level), W - 40, 760);
		canvas.drawString(String.valueOf(no_pht_in_sea), W - 40, 800);
		canvas.drawString(String.valueOf(no_pht_in_mud), W - 40, 840);
		canvas.drawString(String.valueOf(move_y), W - 40, 880);
		canvas.drawString(String.valueOf(land_multiply), W - 40, 920);
		canvas.drawString(String.valueOf(sea_multiply), W - 40, 960);
		canvas.drawString(String.valueOf(on_land), W - 40, 1000);
		if (selection != null) {
