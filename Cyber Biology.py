...
description = "Cyber Biology 2 v1.7 multicell"
        ...
        if botpos[0] < world_scale[0]:
            if botcode[0] != None:
                if world[botpos[0]][botpos[1]] == "none":
                    new_bot = bot.Bot(botpos.copy(), (0, 0, 255), world, objects, bots, sftype=0, brain=copy.deepcopy(botcode[0]))
                    objects.add(new_bot)
...
while keep_going:#основной цикл
    ...
    if render:#отрисовка
        ...
        if selection == None:
            ...
            render_text("Type: " + str(selection.type) + " Diff: " + str(selection.diff[selection.type]), (W - 300, 500))
    ...
    if steps % 25 == 0 and record:#запись
        ...
        for obj in objects:
            if obj.name == "organics":
                ...
                if obj.type == 0:
                    bot_img = Image.new('RGB', (8, 8), (0, 0, 255))
                elif obj.type == 1:
                    bot_img = Image.new('RGB', (8, 8), (0, 128, 255))
                elif obj.type == 2:
                    bot_img = Image.new('RGB', (8, 8), (0, 255, 0))
                elif obj.type == 3:
                    bot_img = Image.new('RGB', (8, 8), (255, 0, 0))
                elif obj.type == 4:
                    bot_img = Image.new('RGB', (8, 8), (255, 0, 255))
                elif obj.type == 5:
                    bot_img = Image.new('RGB', (8, 8), (255, 255, 0))
                elif obj.type == 6:
                    bot_img = Image.new('RGB', (8, 8), (0, 255, 255))
                elif obj.type == 7:
                    bot_img = Image.new('RGB', (8, 8), (128, 128, 128))
